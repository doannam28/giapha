  ...
  (p._events = s),
    ...
    (p.on = function (n, e) {
      ...
      for (var t = n.split(i), r = s, f = 0, o = t.length; o > f; f++)
        (r = r.n),
          (r = (r.hasOwnProperty(t[f]) && r[t[f]]) || (r[t[f]] = { n: {} }));
...
(function (t, e) {
    ...
    for (x = 0; l > x; x++)
      for (var m = 0; c > m; m++) {
        var y = f[x],
          ...
          _ = p[m],
          w = p[m + 1],
          k = 0.001 > V(b.x - y.x) ? "y" : "x",
          B = 0.001 > V(w.x - _.x) ? "y" : "x",
  ...
  function f(t, n, r) {
    ...
    for (
      var i, a, s, o, u, l, h, f, p, d, g = r ? 0 : [], x = 0, v = t.length;
      v > x;
      x++
    ) {
      var m = t[x];
      if ("M" == m[0]) (i = u = m[1]), (a = l = m[2]);
        ...
        "C" == m[0]
          ? ((p = [i, a].concat(m.slice(1))), (i = p[6]), (a = p[7]))
              ...
              case "transform":
                ...
                if (R)
                  for (
                    ...
                    for (
                      y[S][w] = [v[S][w][0]], A = 1, P = v[S][w].length;
                      P > A;
                      A++
                    )
  ...
  (e.color = function (t) {
    ...
    (e.parsePathString = function (t) {
      ...
      var r = {
        ...
        i = [];
      return (
        e.is(t, W) && e.is(t[0], W) && (i = Fe(t)),
        i.length ||
          M(t).replace(se, function (t, e, n) {
            var a = [],
              s = e.toLowerCase();
            if (
              ...
              for (
                ;
                a.length >= r[s] && (i.push([e][L](a.splice(0, r[s]))), r[s]);
    ...
    (e.parseTransformString = i(function (t) {
      ...
      var n = [];
      return (
        e.is(t, W) && e.is(t[0], W) && (n = Fe(t)),
        n.length ||
          M(t).replace(oe, function (t, e, r) {
            var i = [];
            j.call(e),
  ...
  var Ce = (e.pathBBox = function (t) {
      ...
      for (
        ...
        if ((r.push((h = [])), (c = t[p]), c[0] != te.call(c[0])))
          switch (((h[0] = te.call(c[0])), h[0])) {
            ...
            case "R":
              for (
                var g = [i, a][L](c.slice(1)), x = 2, v = g.length;
                v > x;
                x++
              )
                (g[x] = +g[x] + i), (g[++x] = +g[x] + a);
    ...
    Ie = i(function (t, e, n, r, i, a, s, o) {
      ...
      return (
        ...
        p > 0 &&
          ...
          ((u = Me(t, e, n, r, i, a, s, o, p)), g.push(u.x), d.push(u.y)),
        {
          min: { x: O[T](0, g), y: O[T](0, d) },
          max: { x: z[T](0, g), y: z[T](0, d) },
        }
      );
    }),
    Re = (e._path2curve = i(
            ...
            "t" == _ && 3 == b
              ...
              ? 2 == b || 3 == b
                ...
                : 5 == b &&
                  ...
                  (o *= y[1]),
                  (u *= y[2]))
              : "m" == _ && 7 == b && h.add(y[1], y[2], y[3], y[4], y[5], y[6]),
              (l.dirtyT = 1),
              (t.matrix = h);
          }
        (t.matrix = h),
    ...
    Oe = (e._equaliseTransform = function (t, n) {
      ...
      for (
        var r, i, a, s, o = z(t.length, n.length), u = [], l = [], h = 0;
        o > h;
        h++
      ) {
        if (
  ...
  (e._getContainer = function (t, n, r, i) {
    var a;
    return (
      (a = null != i || e.is(t, "object") ? t : S.doc.getElementById(t)),
      null != a
        ? a.tagName
          ? null == n
            ? {
              ...
              var i = A && q[e] ? q[e] : e,
                a = function (i) {
                  var a =
                    ...
                    s =
                      S.doc.documentElement.scrollLeft || S.doc.body.scrollLeft,
                    o = i.clientX + s,
                    u = i.clientY + a;
                  if (A && q[B](e))
                    for (
                      var l = 0, h = i.targetTouches && i.targetTouches.length;
                      h > l;
                      l++
                    )
          ...
          ? function (t, e, n, r) {
              var i = function (t) {
                ...
                var e = S.doc.documentElement.scrollTop || S.doc.body.scrollTop,
                  ...
                  s = t.clientY + e;
                return (
                  (t.preventDefault = t.preventDefault || Xe),
  ...
  (Ze.data = function (n, r) {
    ...
    (Ze.removeData = function (t) {
      return (
        null == t ? (le[this.id] = {}) : le[this.id] && delete le[this.id][t],
        this
      );
    }),
    (Ze.getData = function () {
  ...
  var tn = function (t, n, r, i, a, s, o, h, c) {
    ...
    en = function (t, n) {
      return function (r, i, a) {
        r = Re(r);
        for (
          var s, o, u, l, h, c = "", f = {}, p = 0, d = 0, g = r.length;
          g > d;
          d++
        ) {
          if (((u = r[d]), "M" == u[0])) (s = +u[1]), (o = +u[2]);
            ...
            if (
              ((l = tn(s, o, u[1], u[2], u[3], u[4], u[5], u[6])), p + l > i)
            ) {
              if (n && !f.start) {
                if (
                  ((h = tn(s, o, u[1], u[2], u[3], u[4], u[5], u[6], i - p)),
  ...
  var sn = (e.easing_formulas = {
    ...
    elastic: function (t) {
      return t == !!t
        ? t
        : X(2, -10 * t) * D.sin(((t - 0.075) * 2 * Y) / 0.3) + 1;
    },
    bounce: function (t) {
      var e,
        n = 7.5625,
                ...
                if (h[B](m)) {
                  switch (ne[m]) {
                    ...
                    case "transform":
                      if (c[m].real)
                        for (a = [], y = 0, b = h[m].length; b > y; y++)
                          for (
                            a[y] = [h[m][y][0]], _ = 1, w = h[m][y].length;
                            w > _;
                            _++
                          )
                            a[y][_] = h[m][y][_] + x * u * c[m][y][_];
                    ...
                    default:
                      var S = [][L](h[m]);
                      for (
                        a = [], y = p.paper.customAttributes[m].length;
                        y--;
  ...
  var cn = function (t) {
      if (((this.items = []), (this.length = 0), (this.type = "set"), t))
        for (var e = 0, n = t.length; n > e; e++)
          !t[e] ||
            (t[e].constructor != Ze.constructor && t[e].constructor != cn) ||
  ...
  return (
    ...
    (e.registerFont = function (t) {
      ...
      if (
        (this.fonts[n] ? this.fonts[n].push(e) : (this.fonts[n] = [e]), !t.svg)
      ) {
    ...
    (b.getFont = function (t, n, r, i) {
      if (
        ...
        (n =
          +n ||
          { normal: 400, bold: 700, lighter: 300, bolder: 800 }[n] ||
          400),
        e.fonts)
      ) {
        var a = e.fonts[t];
  ...
  if (t.svg) {
    ...
    var x = function (n, i) {
      ...
      v = function (e, i) {
        ...
        if (!y) {
          if (
            ((i = r(i).replace(t._radial_gradient, function (t, e, r) {
              if (((h = "radial"), e && r)) {
                (f = n(e)), (p = n(r));
                var i = 2 * (p > 0.5) - 1;
                u(f - 0.5, 2) + u(p - 0.5, 2) > 0.25 &&
                  (p = a.sqrt(0.25 - u(f - 0.5, 2)) * i + 0.5) &&
                  0.5 != p &&
        ...
        return (
          x(d, { fill: "url(#" + l + ")", opacity: 1, "fill-opacity": 1 }),
          (v.fill = c),
          (v.opacity = 1),
          (v.fillOpacity = 1),
          1
              ...
              case "clip-rect":
                ...
                if (4 == k.length) {
                  ...
                  (B.id = t.createUUID()),
                    ...
                    x(u, { "clip-path": "url(#" + B.id + ")" }),
                    (n.clip = S);
                }
                if (!g) {
                  var A = u.getAttribute("clip-path");
                  if (A) {
                    var T = t._g.doc.getElementById(
                      A.replace(/(^url\(#|\)$)/g, c)
                    );
              ...
              case "stroke":
                (L = t.getRGB(g)),
                  ...
                  "stroke" == d &&
                    ...
                    x(u, {
                      "stroke-opacity":
                        L.opacity > 1 ? L.opacity / 100 : L.opacity,
                    }),
                  "stroke" == d &&
                    n._.arrows &&
                    ("startString" in n._.arrows &&
    ...
    (B.prototype = S),
      ...
      (t._engine.path = function (t, e) {
        ...
        var n = new B(r, e);
        return (
          (n.type = "path"), w(n, { fill: "none", stroke: "#000", path: t }), n
        );
      }),
      ...
      (S.scale = function (t, e, i, a) {
        ...
        if (
          ((t = r(t).split(h)),
          t.length - 1 && ((e = n(t[1])), (i = n(t[2])), (a = n(t[3]))),
          (t = n(t[0])),
          null == e && (e = t),
          null == a && (i = a),
          null == i || null == a)
      ...
      (S.remove = function () {
        if (!this.removed && this.node.parentNode) {
          ...
          for (var r in this)
            this[r] =
              "function" == typeof this[r] ? t._removedFactory(r) : null;
          this.removed = !0;
        }
      }),
      (S._getBBox = function () {
      ...
      (S.insertAfter = function (e) {
        ...
        return (
          r.nextSibling
            ? r.parentNode.insertBefore(this.node, r.nextSibling)
      ...
      (t._engine.circle = function (t, e, r, n) {
        ...
        var a = new B(i, t);
        return (
          (a.attrs = { cx: e, cy: r, r: n, fill: "none", stroke: "#000" }),
          (a.type = "circle"),
          x(i, a.attrs),
          a
        );
      ...
      (t._engine.image = function (t, e, r, n, i, a) {
        ...
        var o = new B(s, t);
        return (
          (o.attrs = { x: r, y: n, width: i, height: a, src: e }),
          (o.type = "image"),
          o
        );
      }),
      ...
      (t._engine.create = function () {
        ...
        return (
          ...
          1 == r
            ? ((u.style.cssText =
                h + "position:absolute;left:" + n + "px;top:" + i + "px"),
      ...
      (t._engine.setViewBox = function (t, e, r, n, i) {
        ...
        var a,
          o,
          u = s(r / this.width, n / this.height),
          h = this.top,
          c = i ? "meet" : "xMinYMin";
        for (
          null == t
      ...
      (t.prototype.renderfix = function () {
        ...
        (i || a) &&
          (i &&
            ((this._left = (this._left + i) % 1), (r.left = this._left + "px")),
  ...
  if (t.vml) {
      ...
      A = function (n, l) {
        ...
        if (
          ...
          if (
            ...
            l.fill && (P.on = !0),
            (null == P.on || "none" == l.fill || null === l.fill) &&
              (P.on = !1),
            P.on && l.fill)
          ) {
          ...
          if (
            ...
            O.dashstyle = W[e](l["stroke-dasharray"])
            ...
            return (
              ...
              e &&
                ...
                o(e - 0.5, 2) + o(r - 0.5, 2) > 0.25 &&
                  (r =
                    n.sqrt(0.25 - o(e - 0.5, 2)) * (2 * (r > 0.5) - 1) + 0.5),
                (h = e + p + r)),
              d
            );
          })),
    ...
    (N.prototype = E),
      ...
      (E.transform = function (e) {
        ...
        if ((o.translate(-0.5, -0.5), c || u || "image" == this.type))
          if (
            ((l.matrix = "1 0 0 1"),
            (l.offset = "0 0"),
            (s = o.split()),
