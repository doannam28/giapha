...
$(function () {
    datatables_columns = [{
        ...
        template: function (t) {
            var e = {
                0: { title: "Không hiển thị", class: "m-badge--danger" },
                1: { title: "Hiển thị", class: "m-badge--primary" },
            };

            html = '<span data-field="is_status" data-value="' + (t.is_status == 1 ? 0 : 1) + '" class="m-badge ' + e[t.is_status].class + ' m-badge--wide btnUpdateField" style="padding: .65rem 1rem;border-radius: 2rem;">' + e[t.is_status].title + "</span>";
            return html;
        }
    }, {
        field: "action",
