...
$(function() {
    datatables_columns = [{
        ...
        template: function (t) {
            ...
            return '<span data-field="is_status" data-value="'+(t.is_status == 1 ? 0 : 1)+'" class="m-badge ' + e[t.is_status].class + ' m-badge--wide btnUpdateField" style="padding: .65rem 1rem;border-radius: 2rem;">' + e[t.is_status].title + "</span>"
        }
    }, {
        field: "action",
        width: 250,
