 ...
 *  </code>
 */
class Google_Service_Apigee_Resource_OrganizationsSitesPagesMenutypes extends Google_Service_Resource
{
  /**
   * Lists the menu types that reference a specific page.
   * (menutypes.listOrganizationsSitesPagesMenutypes)
   *
   ...
   */
  public function listOrganizationsSitesPagesMenutypes($parent, $optParams = array())
  {
