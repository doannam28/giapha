 ...
 *   $resources = $apigeeService->resources;
 *  </code>
 */
class Google_Service_Apigee_Resource_OrganizationsProvidersResources extends Google_Service_Resource
{
   ...
   */
  public function createResource($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('createResource', array($params), "Google_Service_Apigee_GoogleCloudApigeeV1StringResponse");
  }
  /**
   * Deletes a resource. (resources.delete)
   *
   * @param string $name Required. Name of the resource. Use the following
   * structure in your request:
   * `organizations/{org}/providers/{provider}/resources/{resource}`
