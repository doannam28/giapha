...
class Google_Service_BigQueryReservation_Resource_ProjectsLocations extends Google_Service_Resource
{
   ...
   * be returned. Same logic applies if the request is about a folder. If the
   ...
   * is projects/locations, instead of   projects/locationsreservations. Note "-"
   ...
   * updated. Singleton BI reservation always exists with default size 0. In order
   * to reserve BI capacity it needs to be updated to an amount greater than 0. In
