 ...
 *  </code>
 */
class Google_Service_Customsearch_Resource_Siterestrict extends Google_Service_Resource
{
  /**
   ...
   * patterns. (siterestrict.listSiterestrict)
   *
   ...
   */
  public function listSiterestrict($optParams = array())
  {
    $params = array();
