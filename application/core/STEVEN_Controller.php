...
class STEVEN_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->helper(array('cookie', 'banner', 'data', 'security', 'url', 'directory', 'file', 'form', 'datetime', 'debug', 'text'));
...
class Admin_Controller extends STEVEN_Controller
{
    ...
    public function __construct()
    {
        ...
        //load helper
        $this->load->helper(array('image', 'format', 'link', 'button'));
        //Load config
        ...
        if (
            ...
            if ($this->ion_auth->logged_in()) {
                if ($this->ion_auth->in_group(1) != true) {
                    ...
                    // dump($this->session->admin_permission);
    ...
    public function switchLanguage($lang_code = "")
    {
        ...
        $languageFolder = !empty($this->config->item('language_folder')[$language_code]) ? $this->config->item('language_folder')[$language_code] : '';
    ...
    public function delete_cache_all()
    {
...
class Public_Controller extends STEVEN_Controller
{
    ...
    public function __construct()
    {
        ...
        //load helper
        $this->load->helper(array('navmenus', 'cookie', 'link', 'format', 'image', 'download'));
