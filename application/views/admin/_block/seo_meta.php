...
<div class="form-group">
    ...
    <label for="title"><span class="count-title">0</span> / <?= $this->config->item('SEO_title_maxlength') ?></label>
...
<div class="form-group">
    ...
    <label for="desc"><span class="count-desc">0</span> / <?= $this->config->item('SEO_description_maxlength') ?></label>
