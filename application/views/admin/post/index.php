                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link active show" data-toggle="tab" href="#tab_language"
                                        role="tab" aria-selected="true">
                                        <i class="la la-language"></i>Nội dung SEO
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_info" role="tab"
                                        aria-selected="false">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="category_id" class="form-control category" style="width: 100%;"></select>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script type="text/javascript">
    var url_ajax_load_category = '<?= site_admin_url('category/ajax_load/news') ?>';
</script>