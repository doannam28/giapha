...
<head>
    ...
    <!--end::Web font -->
    <!--begin::Base Styles -->
    <link href="<?= $this->templates_assets ?>assets/vendors/base/vendors.bundle.css" rel="stylesheet"
          type="text/css"/>
    <link href="<?= $this->templates_assets ?>assets/demo/default/base/style.bundle.css" rel="stylesheet"
          type="text/css"/>
    <!--end::Base Styles -->
    <link rel="shortcut icon" href="<?= $this->templates_assets ?>assets/demo/default/media/img/logo/favicon.ico"/>
    <style>
        .g-recaptcha{
            margin: 15px 0 25px;
        }
...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3"
         id="m_login"
         style="background-image: url(<?= $this->templates_assets ?>assets/app/media/img//bg/bg-2.jpg);">
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
                        <img src="<?= $this->templates_assets ?>assets/app/media/img//logos/logo-1.png">
                    </a>
                </div>
                <div class="m-login__signin">
                    ...
                    <?= form_open(site_admin_url('user/ajax_login'), ['class' => 'm-login__form m-form']); ?>
                    ...
                    <div class="m-login__form-action">
                        <input type="hidden" name="url_redirect" value="<?= $this->input->get('url') ?>">
...
<script src="<?= $this->templates_assets ?>assets/demo/default/base/scripts.bundle.js"
