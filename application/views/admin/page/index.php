                            ...
                            <div class="tab-pane active show" id="tab_language" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label>Tóm tắt</label>
                                            <textarea name="description" placeholder="Tóm tắt" class="form-control summernote" rows="5"></textarea>
                                        </div>
...
<script type="text/javascript">
    var url_ajax_load_category = '<?= site_admin_url('category/ajax_load/' . $this->_controller) ?>';
</script>