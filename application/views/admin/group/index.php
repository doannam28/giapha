    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
                            <li class="nav-item m-tabs__item">
                                <a class="nav-link m-tabs__link active show" data-toggle="tab" href="#tab_info" role="tab" aria-selected="true">
                                    <i class="la la-language"></i>Thông tin
                                </a>
                            </li>
                            <li class="nav-item m-tabs__item tab_admin">
                                <a class="nav-link m-tabs__link" data-toggle="tab" href="#tbl_per" role="tab" aria-selected="false">
                            ...
                            <div class="form-group">
                                <table class="table table-hover" id="tbl_per">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $arr_not = array('log', 'menus', 'setting');
                                        ...
                                        ?>
                                                <tr id="per_<?= $name; ?>">
                                                    <td>
                                                        <?= !empty($this->config->item('cms_language_role')[$name]) ? $this->config->item('cms_language_role')[$name] : ucfirst($name); ?>
                                                    </td>

                                                    <td class="text-center">
                                                        <label class="m-checkbox">
                                                            <input type="checkbox" id="per_<?= $name; ?>_view" name="permission[<?= $name; ?>][view]" value="1" />
                                                            <span></span>
                                                        </label>
                                                    </td>
                                                    <?php if (!in_array($name, $arr_not)) : ?>
                                                        <td class="text-center">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" id="per_<?= $name; ?>_add" name="permission[<?= $name; ?>][add]" value="1" />
                                                                <span></span>
                                                            </label>
                                                        </td>
                                                        <td class="text-center">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" id="per_<?= $name; ?>_edit" name="permission[<?= $name; ?>][edit]" value="1" />
                                                                <span></span>
                                                            </label>
                                                        </td>
                                                        <td class="text-center">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" id="per_<?= $name; ?>_delete" name="permission[<?= $name; ?>][update]" value="1" />
                                                                <span></span>
                                                            </label>
                                                        </td>
                                                        <td class="text-center">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" id="per_<?= $name; ?>_delete" name="permission[<?= $name; ?>][delete]" value="1" />
                                                                <span></span>
                                                            </label>
                                                        </td>
                                                    <?php endif ?>
                                        ...
                                        ?>
                                        <?php $list = ['news', 'events']; ?>
                                        <?php if (!empty($list)): foreach ($list as $name): ?>
                                                <tr id="per_<?= $name; ?>">
                                                    <td>
                                                        <?= !empty($this->config->item('cms_language_role')[$name]) ? $this->config->item('cms_language_role')[$name] : ucfirst($name); ?>
                                                    </td>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btnSaveCopy">Save</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
    var url_ajax_load_group = '<?= site_admin_url('group/ajax_load') ?>';
</script>