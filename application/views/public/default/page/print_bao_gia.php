...
<head>
	<title>Báo giá sản phẩm ketsatphugiaan.vn</title>
    <meta http-equiv="content-type" content="text/html; charset=utf-8">
	<META NAME="description" CONTENT="Báo giá sản phẩm ketsatphugiaan.vn">
	<META NAME="keywords" CONTENT= "Báo giá sản phẩm ketsatphugiaan.vn">
	<META NAME="PAGE-TOPIC" content="Báo giá sản phẩm ketsatphugiaan.vn">
	<META name="revisit-after" content="2 days">
	<META NAME="ROBOTS" CONTENT= "INDEX, FOLLOW">
	<META NAME="distribution" content= "global">
	<META NAME="Copyright" content="ketsatphugiaan.vn">
		...
		<div style="width:900px; font-size:14px; position:relative; text-align:left; padding-right:1px; padding-top:15px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<?= !empty($this->_settings->header_bao_gia) ? $this->_settings->header_bao_gia : ''; ?>
			...
			<table class="list_table" cellspacing="0" cellpadding="5" rules="all" border="1" id="dgOrder" style="background-color:White;border-color:#C4C4CF;border-width:1px;border-style:Solid;font-family: 'Times New Roman', Times, serif;width:100%;border-collapse:collapse;">
				...
				?>
					<tr style="background-color:#FFFFFF;">
						...
						<td align="left">
							<strong>
								<div class="title"><?= $data_product->title ?></div>
							</strong>
							<div class="content" style="padding-top:6px;">
								<strong>Bảo hành:</strong> 
								<span style="text-transform:lowercase"><?= $data_product->guarantee; ?></span>
							</div>
						</td>
						<td align="center" valign="middle">
							<img alt="<?= $data_product->title ?>" src="<?= getImageThumb($data_product->thumbnail,80,80); ?>" width="80px" />
						</td>
						<td align="left" valign="middle">
							<div class="content">
								<strong><?= $data_product->size; ?></strong>
							</div>
						</td>
						<td align="center" valign="middle">
							<div class="content">
								<strong><?= $data_product->mass; ?></strong>
							</div>
						</td>
						<td align="right" valign="middle">
							<div style="font-weight:bold"><?= number_format($value->price*$value->quantity,0,'','.'); ?></div>
						</td>
					</tr>
				<?php endforeach; ?>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="70%">&nbsp;</td>
					<td width="30%" align="center">TP. HCM, <?= 'ngày '.date('d').' tháng '.date('m').' năm '.date('Y') ?></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td align="center">
