    ...
    <style>
        ...
        *:before {
        ...
        .error-page {
            ...
            text-align: center;
            background: #0f5bbd;
            background: -moz-linear-gradient(top, #0f5bbd 0%, white 100%);
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #0f5bbd), color-stop(100%, white));
            background: -webkit-linear-gradient(top, #0f5bbd 0%, white 100%);
            background: -o-linear-gradient(top, #0f5bbd 0%, white 100%);
            background: -ms-linear-gradient(top, #0f5bbd 0%, white 100%);
            background: linear-gradient(to bottom, #0f5bbd 0%, white 100%);
...
<body>
    <div class="error-page-wrap">
        <article class="error-page gradient">
            <hgroup>
                <h1>404</h1>
                <h2>oops! Không tìm thấy nội dung</h2>
            </hgroup>
